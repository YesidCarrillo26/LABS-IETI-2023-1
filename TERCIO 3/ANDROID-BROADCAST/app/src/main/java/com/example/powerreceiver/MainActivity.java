...
public class MainActivity extends AppCompatActivity {
    ...
    //private static final String ACTION_CUSTOM_BROADCAST = BuildConfig.APPLICATION_I  + ".ACTION_CUSTOM_BROADCAST";
    private static final String ACTION_CUSTOM_BROADCAST = "com.example.powerreceiver.ACTION_CUSTOM_BROADCAST";
